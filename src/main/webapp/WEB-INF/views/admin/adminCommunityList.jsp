...
<div id="member-list" class="content-wrapper">
    ...
    <section class="content">
        ...
        <button class="btn btn-block btn-outline-secondary" style="width: 4rem; height: 2rem;font-size: .8rem;position: absolute;right: 0px;" data-toggle="modal" data-target="#addBoardModal">글쓰기</button>
        </div>
