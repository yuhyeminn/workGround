		  ...
		  $.ajax({
				...
				success: data => {
					...
					var listObj = new ej.dropdowns.MultiSelect({
					      ...
					      itemTemplate: '<div><img class="empImage img-circle img-sm-profile" src="'+contextPath+'/resources/img/profile.jfif" width="35px" height="35px"/>' +
					      '<div class="ename">${memberName}</div><div class="job"> ${deptTitle} </div></div>',
					      valueTemplate: '<div style="width:100%;height:100%;">' +
					          '<img class="value" src="'+contextPath+'/resources/img/profile.jfif" height="26px" width="26px"/>' +
