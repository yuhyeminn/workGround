...
create table project(
    ...
    project_importance_yn char(1) default 'N',
    ...
    constraint ck_project_importance_yn check(project_importance_yn in ('Y','N'))
);
...
insert into project values(seq_project.nextval, 'kh2020115', '개발1팀', default, '개발 1팀 프로젝트입니다', 'N', default, null, null, null);
insert into project values(seq_project.nextval, 'kh2020122', '개발2팀', default, '개발 2팀 프로젝트입니다', 'Y', default, null, null, 'PS1');
...
select * from project;
select * from project_members where project_no = 1;
